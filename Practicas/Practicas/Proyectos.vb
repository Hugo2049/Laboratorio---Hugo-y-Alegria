...
Public Class Proyectos
    ...
    Private Sub Button2_Click_1(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Try
            cmd = conn.CreateCommand
            cmd.CommandText = "UPDATE proyectos SET nombre_proyecto =@nom, pais = @pais, departamento = @departamento, fecha_de_inicio =@fechin, fecha_de_finalizacion = @fechfin, costo =@cost, donante = @don WHERE id_proyecto =@id"
            cmd.Parameters.AddWithValue("@nom", TextBox1.Text)
            cmd.Parameters.AddWithValue("@pais", TextBox2.Text)
            cmd.Parameters.AddWithValue("@departamento", TextBox5.Text)
            cmd.Parameters.AddWithValue("@fechin", DateTimePicker1.Text)
            cmd.Parameters.AddWithValue("@fechfin", DateTimePicker2.Text)
